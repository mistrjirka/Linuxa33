...
spec = importlib.util.spec_from_file_location(
    "u0k_observer", HERE / "boot-observe-a33-u0k-direct-mount-isolation.py"
)
...
assert observer.PROFILE.expected_flash_operation == "flash-exact-u0k-direct-mount-isolation"
assert observer.PROFILE.flash_report_name == "a33-first-rootfs-u0k-direct-mount-isolation-flash.txt"
assert observer.PROFILE.output_prefix == "u0k-direct-mount-isolation-observation"
assert observer.PROFILE.observation_operation == "observe-u0k-direct-mount-isolation"
...
try:
    ...
    raise AssertionError("unsafe U0k observer profile was accepted")

print("u0k_observer_profile_self_test=passed")
print("u0k_flash_report_contract=passed")
