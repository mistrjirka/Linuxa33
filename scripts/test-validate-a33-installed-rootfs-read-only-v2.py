...
assert module.EXPECTED_ROOTFS_VERIFY_BLOB == "3968d9b2a439ac222b652a79306e611d23525579"
...
assert (
    module.base.common.VERIFY_SCRIPT
    == module.rootfs_verify.ROOTFS_SAFE_VERIFY_SCRIPT
)
...
for required in (
    'mount -t ext4 -o ro,noload,nosuid,nodev,noatime "$target"',
    "rootfs_resolve()",
...
for required in (
    ...
    "rootfs_verify.ROOTFS_SAFE_VERIFY_SCRIPT",
...
print("base_block_identity_and_verify_helper_blobs_pinned=passed")
print("text_safe_ext4_identity_override=passed")
print("rootfs_relative_symlink_safe_verify_override=passed")
