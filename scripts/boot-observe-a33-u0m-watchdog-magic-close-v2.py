...
flash_v2 = load("a33_u0m_observer_v2_flash", FLASH_V2)
common = flash_v2.base.common
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Controlled observer for U0m driver-log-verified watchdog handoff"
    )
...
if __name__ == "__main__":
    try:
        ...
        print(f"REFUSING U0m v2 OBSERVER: {exc}", file=sys.stderr)
        raise SystemExit(1)
