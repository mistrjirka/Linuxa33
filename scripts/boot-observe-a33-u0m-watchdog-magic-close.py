...
common = load(
    "a33_u0m_observer_common",
    HERE / "flash-a33-u0i-python-direct-root-v2.py",
)
u0m = load(
    "a33_u0m_observer_flash",
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Controlled observer for the U0m watchdog magic-close boot"
    )
...
if __name__ == "__main__":
    try:
        ...
        print(f"REFUSING U0m OBSERVER: {exc}", file=sys.stderr)
        raise SystemExit(1)
